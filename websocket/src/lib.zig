// This is from the zig master branch.
// Link: https://github.com/ziglang/zig/commit/b9fd0eeca6ba45058ed67fc211bb50a93c971a28
...
fn recv(ws: *WebSocket, len: usize) RecvError![]u8 {
    ...
    if (len > ws.recv_fifo.count) {
        ...
        // const n = ws.reader.readAtLeast(buf, needed) catch |err| {
        //     std.log.warn("readAtLeast failed\n", .{});
        //     const new_err = @as(RecvError, @errorCast(err));
        //     return new_err;
        // };
